...
<a className="text-slate-600 dark:text-slate-400 text-sm font-medium hover:text-primary transition-colors" href="#">Templates</a>
...
<input className="h-10 w-64 rounded-xl border-none bg-slate-100 dark:bg-slate-800 pl-10 pr-4 text-sm focus:ring-2 focus:ring-primary/20" placeholder="Search policy..." type="text"/>
</div>
<div className="size-10 rounded-full bg-slate-200 dark:bg-slate-700 overflow-hidden border border-slate-200 dark:border-slate-800">
...
<div>
<h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 mb-4">Table of Contents</h3>
<nav className="flex flex-col gap-1">
<a className="flex items-center gap-3 px-4 py-3 rounded-xl bg-primary/10 text-primary font-semibold" href="#introduction">
<span className="material-symbols-outlined text-xl">info</span>
<span className="text-sm">Introduction</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" href="#data-collection">
<span className="material-symbols-outlined text-xl">database</span>
<span className="text-sm">Information We Collect</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" href="#data-usage">
<span className="material-symbols-outlined text-xl">settings</span>
<span className="text-sm">How We Use Your Data</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" href="#data-security">
<span className="material-symbols-outlined text-xl">shield_lock</span>
<span className="text-sm">Data Security</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" href="#user-rights">
<span className="material-symbols-outlined text-xl">verified_user</span>
<span className="text-sm">Your Rights</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" href="#cookies">
...
<h4 className="text-sm font-bold text-slate-900 dark:text-white mb-2">Need help?</h4>
<p className="text-xs text-slate-500 dark:text-slate-400 mb-4">If you have questions about our privacy policy, please contact our support team.</p>
<a className="text-sm font-semibold text-primary hover:underline" href="mailto:privacy@shopdynamics.com">privacy@shopdynamics.com</a>
</div>
</div>
</aside>
...
<div className="mb-10">
<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 text-xs font-medium mb-4">
<span className="material-symbols-outlined text-sm">calendar_today</span>
                        Last Updated: October 24, 2025
                    </div>
<h1 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tight mb-4">Privacy Policy</h1>
...
<div className="bg-primary/5 p-6 rounded-xl border-l-4 border-primary my-6">
<p className="text-sm font-medium text-slate-700 dark:text-slate-300 m-0 italic">
...
<a className="text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-primary" href="#">Terms of Service</a>
<a className="text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-primary" href="#">Cookie Policy</a>
<a className="text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-primary" href="#">Contact Us</a>
</div>
</div>
</article>
</main>
...
<p className="text-slate-400 text-sm">Empowering creators with the world's finest digital templates. Secure, fast, and professional.</p>
</div>
<div className="flex flex-wrap justify-center gap-8">
<div className="flex flex-col gap-3">
<span className="text-xs font-bold uppercase text-slate-500">Marketplace</span>
<a className="text-sm text-slate-300 hover:text-white" href="#">Web Templates</a>
<a className="text-sm text-slate-300 hover:text-white" href="#">UI Kits</a>
</div>
<div className="flex flex-col gap-3">
<span className="text-xs font-bold uppercase text-slate-500">Company</span>
...
<div className="flex flex-col gap-3">
<span className="text-xs font-bold uppercase text-slate-500">Legal</span>
<a className="text-sm text-slate-300 hover:text-white" href="#">Privacy</a>
<a className="text-sm text-slate-300 hover:text-white" href="#">Terms</a>
</div>
</div>
</div>
</footer>
