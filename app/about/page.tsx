...
<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[var(--primary)]/10 text-primary text-xs font-bold uppercase tracking-wider mb-6">
<span className="material-symbols-outlined text-sm">rocket_launch</span>
                    Our Mission
                </div>
<h1 className="text-4xl md:text-6xl font-black tracking-tight mb-6 text-slate-900 dark:text-white leading-tight">
                    Empowering Creators <br/><span className="text-primary">Worldwide</span>
</h1>
...
<button className="cursor-pointer bg-white text-primary px-8 py-4 rounded-xl font-bold shadow-xl shadow-primary/30 hover:scale-105 transition-transform">
                        View Open Roles
                    </button>
</div>
</div>
...
{/* <!-- Value 1 --> */}
<div className="p-8 rounded-2xl bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
<div className="size-14 rounded-xl bg-[var(--primary)]/10 flex items-center justify-center text-primary mb-6">
...
{/* <!-- Meet the Team --> */}
<section className="py-20 bg-background-light dark:bg-slate-900/30">
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
<div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
<div>
<h2 className="text-3xl font-bold mb-4">Meet the Team</h2>
<p className="text-slate-600 dark:text-slate-400">The minds behind the marketplace revolution.</p>
</div>
...
<div className="size-8 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white cursor-pointer hover:bg-[var(--primary)] transition-colors">
...
<p className="text-primary text-sm font-medium">Head of Product Design</p>
</div>
{/* <!-- Member 4 --> */}
<div className="group">
<div className="relative overflow-hidden rounded-2xl aspect-[4/5] mb-4">
...
<p className="text-primary text-sm font-medium">VP of Growth</p>
</div>
</div>
</div>
</section>
...
<p className="text-primary-100 text-lg mb-10 max-w-xl mx-auto opacity-90">
                        Whether you're a creator looking to sell or a professional looking for a career change, we'd love to have you.
                    </p>
<div className="flex flex-wrap justify-center gap-4">
<button className="cursor-pointer bg-white text-black px-10 py-4 rounded-xl font-bold shadow-xl shadow-primary/30 hover:scale-105 transition-transform">
                            Apply to Join
                        </button>
<a href="/contactus">
                        <button className="cursor-pointer bg-[var(--primary)]/20 backdrop-blur-sm border border-white/30 text-white px-10 py-4 rounded-xl font-bold shadow-xl shadow-primary/30 hover:scale-105 transition-transform">
                            Contact Us
                        </button>
                        </a>
</div>
