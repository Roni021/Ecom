...
export default function Home() {
  return (
    <div className="bg-[var(--background-light)] dark:bg-[var(--background-dark)] font-display  antialiased">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-left">
              ...
              <h1 className="text-5xl lg:text-7xl font-black leading-[1.1] mb-8 tracking-tight">
                Create Once. <br />
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-[var(--primary)] to-purple-600">Sell Forever.</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  href="/signup"
                  className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-8 py-4 rounded-xl font-bold text-lg hover:shadow-2xl hover:scale-105 transition-colors flex items-center justify-center gap-2"
                >
                  Start Selling
                </Link>
              </div>
            ...
            <div className="relative">
              <div className="relative z-10 grid grid-cols-2 gap-4">
                <div className="space-y-4 pt-12">
                  <div className="rounded-2xl overflow-hidden shadow-2xl rotate-[-2deg]">
                  ...
                  <div className="rounded-2xl overflow-hidden shadow-2xl rotate-[3deg]">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-[var(--primary)]/5 rounded-full blur-3xl -z-10"></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400">Everything you need for your next masterpiece.</p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* <!-- Category Card 1 --> */}
            <a className="group relative aspect-square overflow-hidden rounded-2xl bg-slate-100 dark:bg-slate-800" href="#">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
            ...
            <div className="flex gap-2">
              <button className="px-4 py-2 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm font-semibold hover:bg-slate-50">Newest</button>
              <button className="px-4 py-2 rounded-lg bg-[var(--primary)] text-white text-sm font-semibold">Popular</button>
              <button className="px-4 py-2 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm font-semibold hover:bg-slate-50">Free</button>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* <!-- Product Card 1 --> */}
            <div className="group bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden hover:shadow-xl transition-all">
              ...
              <div className="p-6">
                <div className="flex items-center gap-1 mb-2 text-amber-500">
                  ...
                  <span className="text-xs text-slate-500 font-normal">(128 reviews)</span>
                </div>
                <h3 className="text-lg font-bold mb-2 group-hover:text-[var(--primary)] transition-colors">Neo-Minimalist UI Framework</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm mb-6 line-clamp-2">Complete design system with 500+ customizable components for SaaS products.</p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-slate-600 dark:text-slate-300">Alex Rivers</span>
                  </div>
                  <button className="bg-[var(--primary)]/10 text-[var(--primary)] hover:bg-[var(--primary)] hover:text-white px-4 py-2 rounded-lg text-sm font-bold transition-all">Buy Now</button>
                </div>
              </div>
            </div>
            {/* <!-- Product Card 2 --> */}
            <div className="group bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden hover:shadow-xl transition-all">
              ...
              <div className="p-6">
                <div className="flex items-center gap-1 mb-2 text-amber-500">
                  ...
                  <span className="text-xs text-slate-500 font-normal">(94 reviews)</span>
                </div>
                <h3 className="text-lg font-bold mb-2 group-hover:text-[var(--primary)] transition-colors">Gold Foil Greeting Bundle</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm mb-6 line-clamp-2">Luxury invitation templates with realistic gold foil textures for all occasions.</p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-full bg-slate-200 overflow-hidden">
                    ...
                    <span className="text-xs font-medium text-slate-600 dark:text-slate-300">Sarah Chen</span>
                  </div>
                  <button className="bg-[var(--primary)]/10 text-[var(--primary)] hover:bg-[var(--primary)] hover:text-white px-4 py-2 rounded-lg text-sm font-bold transition-all">Buy Now</button>
                </div>
              </div>
            ...
            <div className="group bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden hover:shadow-xl transition-all">
              ...
              <div className="p-6">
                <div className="flex items-center gap-1 mb-2 text-amber-500">
                  ...
                  <span className="text-xs text-slate-500 font-normal">(210 reviews)</span>
                </div>
                <h3 className="text-lg font-bold mb-2 group-hover:text-[var(--primary)] transition-colors">Creator Social Kit 2024</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm mb-6 line-clamp-2">Viral-ready post and story templates designed for maximum engagement.</p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-full bg-slate-200 overflow-hidden">
                    ...
                    <span className="text-xs font-medium text-slate-600 dark:text-slate-300">Marcus Wright</span>
                  </div>
                  <button className="bg-[var(--primary)]/10 text-[var(--primary)] hover:bg-[var(--primary)] hover:text-white px-4 py-2 rounded-lg text-sm font-bold transition-all">Buy Now</button>
                </div>
              </div>
      ...
      <section className="py-24 bg-slate-50 dark:bg-background-dark/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">Get your hands on world-className design assets in three simple steps.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-24 h-24 bg-[var(--primary)]/10 text-[var(--primary)] rounded-3xl flex items-center justify-center mb-6 shadow-xl shadow-primary/5">
                <span className="material-symbols-outlined text-4xl">search_check</span>
              </div>
              <h3 className="text-xl font-bold mb-3">1. Choose</h3>
              <p className="text-slate-600 dark:text-slate-400">Browse thousands of premium digital products from top creators.</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="w-24 h-24 bg-[var(--primary)]/10 text-[var(--primary)] rounded-3xl flex items-center justify-center mb-6 shadow-xl shadow-primary/5">
              ...
              <p className="text-slate-600 dark:text-slate-400">Secure checkout with various payment options and global coverage.</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="w-24 h-24 bg-[var(--primary)]/10 text-[var(--primary)] rounded-3xl flex items-center justify-center mb-6 shadow-xl shadow-primary/5">
              ...
              <p className="text-slate-600 dark:text-slate-400">Instant access to high-resolution source files for your projects.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex items-center justify-center gap-4">
              ...
              <div>
                ...
                <p className="text-slate-500 dark:text-slate-400 text-xs">Access files immediately after payment</p>
              </div>
            </div>
            <div className="flex items-center justify-center gap-4">
              ...
              <div>
                ...
                <p className="text-slate-500 dark:text-slate-400 text-xs">Fully encrypted transaction processing</p>
              </div>
            </div>
            <div className="flex items-center justify-center gap-4">
              ...
              <div>
                ...
                <p className="text-slate-500 dark:text-slate-400 text-xs">Re-download your purchases anytime</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 dark:text-slate-400">Join over 50,000 designers who use our assets daily.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
              ...
              <p className="text-slate-600 dark:text-slate-300 italic mb-6 leading-relaxed">"The quality of the UI kits here is unmatched. They&apos;ve saved our agency hundreds of hours on production work."</p>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-xs">Creative Director, PixelPoint</p>
                </div>
              </div>
            </div>
            <div className="p-8 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
              ...
              <p className="text-slate-600 dark:text-slate-300 italic mb-6 leading-relaxed">"Finding unique greeting card templates used to be a chore. Now it&apos;s my first stop for every holiday season."</p>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-xs">Freelance Illustrator</p>
                </div>
              </div>
            </div>
            <div className="p-8 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
              ...
              <p className="text-slate-600 dark:text-slate-300 italic mb-6 leading-relaxed">"As a seller, the platform is incredibly intuitive. The &apos;sell forever&apos; promise is real &ndash; my passive income is growing monthly!"</p>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-xs">Premium Content Creator</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative bg-[var(--primary)] rounded-[2rem] overflow-hidden p-8 md:p-16 lg:p-24 text-center">
            <div className="absolute inset-0 bg-gradient-to-br from-primary via-[var(--primary)] to-purple-600 opacity-90"></div>
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <Link
                  href="/login"
                  className="cursor-pointer inline-block bg-white text-[var(--primary)] px-10 py-4 rounded-xl font-bold text-lg hover:shadow-xl hover:shadow-black/10 hover:scale-105 transition-all"
                >
                  Get Started Now
                </Link>
                <Link
                  href="/about"
                  className="cursor-pointer bg-[var(--primary)]/20 border border-white/30 text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-white/10 hover:scale-105 transition-all inline-block"
                >
                  Learn More
                </Link>
              </div>
