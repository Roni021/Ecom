...
export default function categoris() {
  return (
    <div className="font-display theme-page theme-text dark:theme-text min-h-screen">
{/* <!-- Header / Navigation --> */}
<nav className="sticky top-0 z-50 theme-surface/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-theme-surface dark:border-slate-800">
...
<span className="font-bold text-xl tracking-tight">Market<span className="theme-accent-text">Place</span></span>
</div>
<div className="hidden md:flex items-center gap-8 text-sm font-medium">
<a className="hover:theme-accent-text transition-colors" href="#">Explore</a>
<a className="theme-accent-text" href="#">Categories</a>
<a className="hover:theme-accent-text transition-colors" href="#">Sell</a>
</div>
<div className="flex items-center gap-4">
<button className="p-2 hover:theme-surface dark:hover:bg-slate-800 rounded-full">
...
{/* <!-- Breadcrumbs --> */}
<nav className="flex mb-8 text-sm theme-text dark:theme-text">
<ol className="flex items-center gap-2">
<li><a className="hover:theme-accent-text" href="#">Home</a></li>
<li className="flex items-center gap-2"><span className="material-icons text-xs">chevron_right</span> <a className="hover:theme-accent-text" href="#">Categories</a></li>
<li className="flex items-center gap-2 theme-text dark:theme-text font-medium"><span className="material-icons text-xs">chevron_right</span> UI Kits</li>
</ol>
</nav>
{/* <!-- Page Header --> */}
<header className="mb-12">
<h1 className="text-4xl font-bold mb-4">UI Kits &amp; Design Systems</h1>
<p className="text-lg theme-text dark:theme-text max-w-2xl leading-relaxed">
...
{/* <!-- Category --> */}
<div>
<h3 className="font-semibold mb-4 theme-text dark:theme-text">Category</h3>
<div className="space-y-3">
<label className="flex items-center gap-3 cursor-pointer group">
<input className="rounded border-slate-300 border-theme-surface theme-accent-text focus:ring-primary h-4 w-4" type="checkbox"/>
<span className="text-sm group-hover:theme-accent-text transition-colors">All UI Kits</span>
</label>
<label className="flex items-center gap-3 cursor-pointer group">
<input className="rounded border-slate-300 border-theme-surface theme-accent-text focus:ring-primary h-4 w-4" type="checkbox"/>
<span className="text-sm group-hover:theme-accent-text transition-colors">Web Dashboards</span>
</label>
<label className="flex items-center gap-3 cursor-pointer group">
<input className="rounded border-slate-300 border-theme-surface theme-accent-text focus:ring-primary h-4 w-4" type="checkbox"/>
<span className="text-sm group-hover:theme-accent-text transition-colors">Mobile Apps</span>
</label>
<label className="flex items-center gap-3 cursor-pointer group">
<input className="rounded border-slate-300 border-theme-surface theme-accent-text focus:ring-primary h-4 w-4" type="checkbox"/>
<span className="text-sm group-hover:theme-accent-text transition-colors">Landing Pages</span>
</label>
</div>
</div>
{/* <!-- Compatibility --> */}
<div>
<h3 className="font-semibold mb-4 theme-text dark:theme-text">Compatibility</h3>
<div className="space-y-3">
<label className="flex items-center gap-3 cursor-pointer group">
<input className="rounded border-slate-300 border-theme-surface theme-accent-text focus:ring-primary h-4 w-4" type="checkbox"/>
<span className="text-sm group-hover:theme-accent-text transition-colors">Figma</span>
</label>
<label className="flex items-center gap-3 cursor-pointer group">
<input className="rounded border-slate-300 border-theme-surface theme-accent-text focus:ring-primary h-4 w-4" type="checkbox"/>
<span className="text-sm group-hover:theme-accent-text transition-colors">Sketch</span>
</label>
<label className="flex items-center gap-3 cursor-pointer group">
<input className="rounded border-slate-300 border-theme-surface theme-accent-text focus:ring-primary h-4 w-4" type="checkbox"/>
<span className="text-sm group-hover:theme-accent-text transition-colors">Adobe XD</span>
</label>
</div>
</div>
{/* <!-- Price Range --> */}
<div>
<h3 className="font-semibold mb-4 theme-text dark:theme-text">Price Range</h3>
<div className="px-2">
...
<div className="flex justify-between mt-2 text-xs theme-text">
<span>$0</span>
<span>$500+</span>
</div>
</div>
...
{/* <!-- Rating --> */}
<div>
<h3 className="font-semibold mb-4 theme-text dark:theme-text">Rating</h3>
<div className="space-y-2">
<button className="flex items-center gap-2 text-sm hover:theme-accent-text">
...
<button className="w-full py-3 bg-slate-900 theme-surface text-white text-sm font-semibold rounded-lg hover:theme-accent transition-colors">
                        Apply Filters
                    </button>
</div>
</aside>
...
<p className="text-sm theme-text">Showing <span className="font-semibold theme-text dark:theme-text">24</span> results</p>
<div className="flex items-center gap-3">
<label className="text-sm font-medium">Sort by:</label>
<select className="theme-surface theme-surface border-theme-surface border-theme-surface rounded text-sm px-4 py-2 focus:ring-primary focus:border-theme-accent">
...
{/* <!-- Product Card 1 --> */}
<div className="group theme-surface theme-surface rounded-xl overflow-hidden border border-theme-surface border-theme-surface hover:shadow-xl transition-all duration-300">
...
<div className="absolute inset-0 theme-accent/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
<button className="theme-surface theme-surface theme-text p-2 rounded-full shadow-lg hover:theme-accent hover:text-white transition-colors">
<span className="material-icons">shopping_cart</span>
</button>
<button className="theme-surface theme-surface theme-text px-4 py-2 rounded-full text-sm font-semibold shadow-lg hover:theme-accent hover:text-white transition-colors">
                                    View Details
                                </button>
</div>
</div>
...
<h3 className="font-bold text-lg group-hover:theme-accent-text transition-colors">Neo-Minimalist Dashboard Kit</h3>
<span className="font-bold theme-accent-text text-xl">$48</span>
</div>
<div className="flex items-center gap-4 mb-4">
<div className="flex items-center gap-1">
<span className="material-icons text-amber-400 text-sm">star</span>
<span className="text-sm font-medium">4.9</span>
<span className="text-xs theme-text">(128)</span>
</div>
...
<div className="p-5">
<div className="flex justify-between items-start mb-2">
<h3 className="font-bold text-lg group-hover:theme-accent-text transition-colors">CryptoWallet Mobile UI Kit</h3>
<span className="font-bold theme-accent-text text-xl">$32</span>
</div>
<div className="flex items-center gap-4 mb-4">
<div className="flex items-center gap-1">
<span className="material-icons text-amber-400 text-sm">star</span>
<span className="text-sm font-medium">4.7</span>
<span className="text-xs theme-text">(84)</span>
</div>
<div className="flex gap-2">
...
<div className="p-5">
<div className="flex justify-between items-start mb-2">
<h3 className="font-bold text-lg group-hover:theme-accent-text transition-colors">Quantum Design System</h3>
<span className="font-bold theme-accent-text text-xl">$99</span>
</div>
<div className="flex items-center gap-4 mb-4">
<div className="flex items-center gap-1">
<span className="material-icons text-amber-400 text-sm">star</span>
<span className="text-sm font-medium">5.0</span>
<span className="text-xs theme-text">(215)</span>
</div>
<div className="flex gap-2">
...
<div className="p-5">
<div className="flex justify-between items-start mb-2">
<h3 className="font-bold text-lg group-hover:theme-accent-text transition-colors">SaaS Hero Sections Pack</h3>
<span className="font-bold theme-accent-text text-xl">$19</span>
</div>
<div className="flex items-center gap-4 mb-4">
<div className="flex items-center gap-1">
<span className="material-icons text-amber-400 text-sm">star</span>
<span className="text-sm font-medium">4.6</span>
<span className="text-xs theme-text">(54)</span>
</div>
<div className="flex gap-2">
...
<div className="p-5">
<div className="flex justify-between items-start mb-2">
<h3 className="font-bold text-lg group-hover:theme-accent-text transition-colors">Marketplace Web Framework</h3>
<span className="font-bold theme-accent-text text-xl">$59</span>
</div>
<div className="flex items-center gap-4 mb-4">
<div className="flex items-center gap-1">
<span className="material-icons text-amber-400 text-sm">star</span>
<span className="text-sm font-medium">4.8</span>
<span className="text-xs theme-text">(92)</span>
</div>
<div className="flex gap-2">
...
<div className="p-5">
<div className="flex justify-between items-start mb-2">
<h3 className="font-bold text-lg group-hover:theme-accent-text transition-colors">DataViz Pro Library</h3>
<span className="font-bold theme-accent-text text-xl">$65</span>
</div>
<div className="flex items-center gap-4 mb-4">
<div className="flex items-center gap-1">
<span className="material-icons text-amber-400 text-sm">star</span>
<span className="text-sm font-medium">4.9</span>
<span className="text-xs theme-text">(156)</span>
</div>
<div className="flex gap-2">
...
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-theme-surface border-theme-surface hover:theme-accent hover:text-white hover:border-theme-accent transition-all">
<span className="material-icons text-sm">chevron_left</span>
</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg theme-accent text-white font-semibold">1</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-theme-surface border-theme-surface hover:theme-accent hover:text-white hover:border-theme-accent transition-all">2</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-theme-surface border-theme-surface hover:theme-accent hover:text-white hover:border-theme-accent transition-all">3</button>
<span className="px-2 theme-text">...</span>
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-theme-surface border-theme-surface hover:theme-accent hover:text-white hover:border-theme-accent transition-all">12</button>
<button className="w-10 h-10 flex items-center justify-center rounded-lg border border-theme-surface border-theme-surface hover:theme-accent hover:text-white hover:border-theme-accent transition-all">
