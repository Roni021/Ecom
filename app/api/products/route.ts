...
const sampleProducts = [
  ...
  },
  {
    ...
    tags: ["celebration", "greeting", "cards", "festive"],
  ...
  {
    title: "Responsive Landing Layout Pack",
    description: "Flexible landing page layouts and section templates designed for quick website launches.",
    price: 20,
    originalPrice: 40,
    category: "layout",
    images: ["https://via.placeholder.com/800x500.png?text=Landing+Layout+Pack"],
    tags: ["layout", "web", "landing page", "design"],
    fileFormats: ["figma", "sketch", "xd"],
    license: "commercial",
    rating: 4.7,
    reviewCount: 98,
    downloads: 530,
  ...
  {
    title: "Visual Stock Photo Bundle",
    description: "High-resolution stock photo collection for marketing, editorial, and social campaigns.",
    price: 16,
    originalPrice: 30,
    category: "photos",
    images: ["https://via.placeholder.com/800x500.png?text=Stock+Photo+Bundle"],
    tags: ["photos", "stock", "marketing", "creative"],
    fileFormats: ["jpg", "png"],
    license: "commercial",
    rating: 4.6,
    reviewCount: 73,
