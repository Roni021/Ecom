...
<p className="text-lg theme-text dark:theme-text">Have questions about our marketplace or need technical support? Our team is ready to help you scale your digital business.</p>
</div>
...
<input className="w-full px-4 py-3 rounded-lg border-theme-surface dark:border-slate-800 bg-slate-50 theme-surface focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all" placeholder="Jane" type="text"/>
</div>
<div className="space-y-2">
<label className="text-sm font-semibold">Last Name</label>
<input className="w-full px-4 py-3 rounded-lg border-theme-surface dark:border-slate-800 bg-slate-50 theme-surface focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all" placeholder="Doe" type="text"/>
</div>
</div>
<div className="space-y-2">
<label className="text-sm font-semibold">Email Address</label>
<input className="w-full px-4 py-3 rounded-lg border-theme-surface dark:border-slate-800 bg-slate-50 theme-surface focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all" placeholder="jane@company.com" type="email"/>
</div>
<div className="space-y-2">
<label className="text-sm font-semibold">Subject</label>
<select className="form-select w-full px-4 py-3 rounded-lg border-theme-surface dark:border-slate-800 bg-slate-50 theme-surface focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all">
...
<textarea className="w-full px-4 py-3 rounded-lg border-theme-surface dark:border-slate-800 bg-slate-50 theme-surface focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all resize-none" placeholder="Tell us how we can help..." rows={5}></textarea>
</div>
<button className="w-full theme-accent text-white font-bold py-4 rounded-lg hover:bg-blue-700 transition-all flex items-center justify-center gap-2 group" type="submit">
                                Send Message
...
<a className="theme-accent-text font-medium hover:underline" href="mailto:support@shopdynamics.com">support@shopdynamics.com</a>
</div>
</div>
<div className="flex items-start gap-4">
<div className="w-12 h-12 theme-accent/10 rounded-lg flex items-center justify-center theme-accent-text shrink-0">
...
<a className="theme-accent-text font-medium hover:underline" href="tel:+15550000000">+1 (555) 000-0000</a>
</div>
</div>
<div className="flex items-start gap-4">
<div className="w-12 h-12 theme-accent/10 rounded-lg flex items-center justify-center theme-accent-text shrink-0">
...
<a className="inline-flex items-center gap-2 theme-surface theme-surface theme-accent-text px-5 py-2.5 rounded-lg font-bold text-sm hover:theme-surface transition-colors" href="#">
                                    Visit Help Center
...
{/* <!-- Socials --> */}
<div>
<h4 className="text-sm font-bold uppercase tracking-widest theme-text mb-4">Follow Us</h4>
<div className="flex gap-4">
<a className="w-10 h-10 border border-theme-surface dark:border-slate-800 rounded-lg flex items-center justify-center hover:theme-accent hover:text-white hover:border-theme-accent transition-all" href="#">
